...
export const RodrigoBanner = () => {
    return (
        <section className="py-16 px-4 md:px-10 bg-background relative z-10">
            <div className="max-w-[1200px] mx-auto bg-muted border border-border rounded-2xl p-8 md:p-12 relative overflow-hidden flex flex-col md:flex-row items-center gap-10">

                {/* Decorational Glow */}
                <div className="absolute top-0 right-0 w-64 h-64 bg-primary/20 rounded-full blur-3xl pointer-events-none"></div>

                <div className="flex-1 relative z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted text-foreground text-xs font-bold tracking-wide uppercase mb-4 border border-border">
