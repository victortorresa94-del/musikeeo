                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                        <div className="relative">
                            ...
                            <input
                                type="date"
                                className="w-full rounded-lg border border-border bg-muted py-2.5 pl-10 pr-3 text-sm text-foreground focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
                            ...
                            <label key={genre} className="flex items-center gap-3 cursor-pointer group">
                                <div className={cn(
                                    ...
                                    filters.genres.includes(genre)
                                        ...
                                        : "border-border bg-muted group-hover:border-primary/60"
                                )}>
                                    <input
                                        type="checkbox"
                                        className="hidden"
                                ...
                                <span className={cn(
                                    ...
                                    filters.genres.includes(genre) ? "text-foreground" : "text-muted-foreground group-hover:text-foreground"
                                )}>{genre}</span>
                            </label>
                        ))}
                    </div>
