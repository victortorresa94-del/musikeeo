...
export const BottomNav = () => {
    ...
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 h-20 bg-background/95 backdrop-blur-xl border-t border-border pb-safe z-50">
                            ...
                            <>
                                ...
                                {isActive && (
                                    <motion.div
                                        ...
                                        className="absolute -top-[1px] w-12 h-1 bg-primary rounded-b-full shadow-[0_0_10px_rgba(255,216,77,0.5)]"
                                    />
                                )}
                            </>
                        )}
